...
void se(void* nau, void* tree, FILE* qry, FILE* qrysvg, FILE* qrytxt); //seleciona
void sec(int nausCap[], void* nau, void* tree, FILE* qry, FILE* qrysvg, FILE* qrytxt);  //seleciona capitas
